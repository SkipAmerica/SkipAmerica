      ...
      <div className="flex items-center gap-3 p-3">
        ...
        {!isOwnPost && showConnectButton && onConnect && (
          <button
            ...
            className="px-3.5 py-1.5 rounded text-xs font-medium text-white bg-[#00C2D8] hover:bg-gradient-to-r hover:from-primary hover:to-primary/80 transition-all duration-200 shadow-[0_1px_2px_rgba(0,0,0,0.1)] flex-shrink-0"
          >
            Connect
          </button>
        )}
