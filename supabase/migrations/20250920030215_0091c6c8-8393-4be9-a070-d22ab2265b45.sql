-- Add JR Issac to creators table with proper UUID
...
BEGIN
    ...
    (jr_creator_id, 'video_call', 120.00, 250.00, 'USD', 'Music production consultation, career advice, creative collaboration discussions', true),
    (jr_creator_id, 'voice_call', 80.00, 150.00, 'USD', 'Quick advice sessions, industry insights, mentorship calls', true),
    (jr_creator_id, 'collaboration', 500.00, 2000.00, 'USD', 'Music production, content collaboration, brand partnerships', true);
