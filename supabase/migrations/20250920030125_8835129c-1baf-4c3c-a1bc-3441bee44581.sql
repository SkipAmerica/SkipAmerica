-- Add JR Issac to creators table
INSERT INTO public.creators (
  ...
  'jr-issac-brooklyn-creator-2024',
  'JR Issac',
...
('jr-issac-brooklyn-creator-2024', 'instagram', '@jrissacbk', 85000, 9.2, 1200000, true, 12.5, true),
('jr-issac-brooklyn-creator-2024', 'tiktok', '@jrissacproducer', 67000, 11.8, 890000, false, 15.3, true),
('jr-issac-brooklyn-creator-2024', 'youtube', 'JR Issac Official', 45000, 7.1, 650000, true, 8.9, true),
('jr-issac-brooklyn-creator-2024', 'twitter', '@jrissacmusic', 23000, 6.4, 180000, true, 5.2, true);
...
('jr-issac-brooklyn-creator-2024', 15, 45.00, 'manual', true),
('jr-issac-brooklyn-creator-2024', 30, 85.00, 'manual', true),
('jr-issac-brooklyn-creator-2024', 60, 160.00, 'manual', true);
...
('jr-issac-brooklyn-creator-2024', 1, '10:00', '18:00', true), -- Monday
('jr-issac-brooklyn-creator-2024', 2, '10:00', '18:00', true), -- Tuesday  
('jr-issac-brooklyn-creator-2024', 3, '10:00', '18:00', true), -- Wednesday
('jr-issac-brooklyn-creator-2024', 4, '10:00', '18:00', true), -- Thursday
('jr-issac-brooklyn-creator-2024', 5, '12:00', '20:00', true), -- Friday
('jr-issac-brooklyn-creator-2024', 6, '11:00', '17:00', true), -- Saturday
('jr-issac-brooklyn-creator-2024', 0, '12:00', '16:00', true); -- Sunday
...
('jr-issac-brooklyn-creator-2024', 'video_call', 120.00, 250.00, 'USD', 'Music production consultation, career advice, creative collaboration discussions', true),
('jr-issac-brooklyn-creator-2024', 'voice_call', 80.00, 150.00, 'USD', 'Quick advice sessions, industry insights, mentorship calls', true),
('jr-issac-brooklyn-creator-2024', 'collaboration', 500.00, 2000.00, 'USD', 'Music production, content collaboration, brand partnerships', true);
